...
let s:colors = {
      ...
      \ "comment_grey": get(s:overrides, "comment_grey", { "gui": "#5C6370", "cterm": "242", "cterm16": "15" }),
      \ "gutter_fg_grey": get(s:overrides, "gutter_fg_grey", { "gui": "#4B5263", "cterm": "240", "cterm16": "15" }),
